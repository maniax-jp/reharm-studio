...
- セルをクリックしてコードエディタで編集: ルート 12 音 / オンコード（ベース指定）/
  22 種のコードクオリティ（maj, m, 7, M7, m7, mM7, add9, sus2, sus4, aug, dim, 9, 6,
  add11, add13, M7sus4, 7sus4, m7b5, dim7, aug7, augM7, blk）
- コードネームを主表示し、ディグリーネームを常に併記
...
- パターン検出: ツーファイブワン・強進行・限定進行・クリシェ・代表進行との一致（部分一致も検出）
...
│   ├── ChordModel.*                 # コード理論コア（22種のコードクオリティ・命名・ディグリー・ボイシング）
